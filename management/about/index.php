 ...
 *******************************************************************************/
	...
	$pageTitle 		= "Gemini Management - About";
...
?>
	...
	<div id="midcolumn">
		<h2>About The Gemini Management Container</h2>
		<p>
			The Gemini Management project had a bumpy start in life but is now being activly developed by 
			committers from SAP and VMware.
			
			
			as the web part of the SpringSource dm Server that has now been 
